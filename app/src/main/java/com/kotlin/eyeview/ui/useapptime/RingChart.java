...
public class RingChart extends View {
    ...
    private List<PieData> viewDataList = new ArrayList<>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i= 0; i < viewDataList.size(); i++){
            PieData data = viewDataList.get(i);
            //设置画笔颜色
        ...
        float width = mPaint.measureText(totaltime,0,totaltime.length());
        canvas.drawText(totaltime,centerX - width/2,centerY+10,mPaint);

    }

    public void setData(List<PieData> viewDataList) {
