...
class PresbyopiaActivity : AppCompatActivity() , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionCount = 2
        mQuestionList = Constants.getPrebyopia(questionCount)
    ...
    private fun setQuestion() {
        ...
        if (mCurrentPosition > mQuestionList!!.size) {
            val intent = Intent(this@PresbyopiaActivity, ResultActivity::class.java)
