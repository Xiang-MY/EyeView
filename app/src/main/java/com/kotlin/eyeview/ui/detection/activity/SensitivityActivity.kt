...
class SensitivityActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionCount = 2
        mQuestionList = Constants.getSensitivity(questionCount)
    ...
    private fun setQuestion () {
        ...
        if (mCurrentPosition > mQuestionList!!.size) {
            val intent = Intent(this@SensitivityActivity, ResultActivity::class.java)
